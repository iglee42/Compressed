package fr.iglee42.compressed;

import dev.architectury.event.events.common.CommandRegistrationEvent;
import dev.architectury.event.events.common.TickEvent;
import dev.architectury.networking.NetworkManager;
import dev.architectury.platform.Platform;
import fr.iglee42.compressed.commands.CCommand;
import fr.iglee42.compressed.config.CConfig;
import fr.iglee42.compressed.packets.handlers.c2s.ExitPlayerFromBoxHandler;
import fr.iglee42.compressed.packets.handlers.c2s.SetBoxNameHandler;
import fr.iglee42.compressed.packets.handlers.c2s.SetPlayerBoxSpawnHandler;
...
public final class Compressed {
    ...
    public static final Component PREFIX = Component.literal("[").withStyle(ChatFormatting.GRAY).append(Component.literal("Compressed").withStyle(ChatFormatting.GREEN)).append(Component.literal("] ").withStyle(ChatFormatting.GRAY));
    ...
    public static void init() {
        ...
        CommandRegistrationEvent.EVENT.register((dispatcher,registry,selection)-> CCommand.create(dispatcher));
    }
