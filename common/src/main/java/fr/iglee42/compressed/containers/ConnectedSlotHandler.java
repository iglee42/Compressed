package fr.iglee42.compressed.containers;
...
public class ConnectedSlotHandler implements Container {
    ...
    public ConnectedSlotHandler(Level level, ChunkPos pos) {
        this.level = level;
        this.pos = pos;
    }
    ...
    private List<SlotModule> getBlockEntities(){
        BlockPos minPos = new BlockPos(pos.getMinBlockX(),64,pos.getMinBlockZ() );
        BlockPos maxPos = new BlockPos(pos.getMaxBlockX(), 80,pos.getMaxBlockZ());
