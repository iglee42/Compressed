package fr.iglee42.compressed.neoforge.client;
...
@EventBusSubscriber(modid = Compressed.MODID, value = Dist.CLIENT)
public class CompressedClientNeoForge {
    ...
    public static void addRenderLayers(RegisterGuiLayersEvent event){
        event.registerAbove(VanillaGuiLayers.HOTBAR, ResourceLocation.fromNamespaceAndPath(Compressed.MODID,"box_hud"), BoxHud.HUD);
    }
